    ...
    <div>
      <div className="donation-container">
        ...
        <div className="bank-transfer">
          ...
          <p><strong>UPI ID:</strong><br /> navgurukulf@kotak</p>
          <p><strong>Name:</strong><br /> Navgurukul Foundation for Social Welfare</p>
          <p><strong>Account Number:</strong><br /> 0512251778</p>
          <p><strong>IFSC Code:</strong><br /> KKBK0004260</p>
        </div>
